	...
	return (
		<footer id="contact" aria-labelledby="footer-heading">
			...
			<div className="mx-auto max-w-7xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-32">
				<div className="flex space-x-6 md:order-2 justify-center">
					{navigation.social.map((item) => (
						<a
							key={item.name}
							href={item.href}
							className="text-[#e126fe] hover:text-pink-500"
						>
				...
				<div className="mt-16 border-t border-black pt-8 lg:mt-24">
					<p className="mt-8 text-xs text-center leading-5 text-gray-500 md:order-1 md:mt-0">
						&copy; 2024 Enjely Lariosa, Inc. All rights reserved.
					</p>
				</div>
			</div>
		</footer>
